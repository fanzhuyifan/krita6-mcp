...
- Native vector-layer creation, typed rectangle/ellipse/polygon/Bézier shapes, snapshot-checked shape transforms/properties/deletion, and adjacent vector-layer merging that retains editable shapes.
...
- Forty-five core tools for discovery, document/layer inspection and creation, native paths and pressure lines, inline PNG previews, layered save, PNG export, operation reconciliation/cancellation, and reference editing.
